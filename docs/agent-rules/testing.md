...
Use browser QA for substantial UI, state, workflow, or release-readiness checks.
Use `.agents/skills/codebase-migrate/SKILL.md` batch guidance for framework, DB, schema, or repeated code transformations.
...
- migrated UI parity for cloned screens, especially cards, colors, banners, tables, button placement, labels, and spacing
