...
- SvelteKit `/settings` มี settings basic สำหรับ config, users, history filters, stock audit, master data ยา/สถานที่ และ export CSV ผ่าน form action แล้ว
...
7. ทดสอบ export UI/settings save config เชิงลึก และตัดสินใจว่าจะต้องคง `.xlsx` แทน CSV หรือไม่
