...
- SvelteKit `/settings` มี settings basic สำหรับ config, users, history filters และ stock audit ผ่าน form action แล้ว
...
5. Migrate master data forms สำหรับยาและสถานที่ใน SvelteKit settings
