...
- SvelteKit `/settings` มี settings basic สำหรับ config, users, history filters, stock audit, master data ยา/สถานที่, upload รูปยา และ export CSV ผ่าน form action แล้ว
...
7. ทำ notification worker/cron ใหม่แทน Apps Script trigger
