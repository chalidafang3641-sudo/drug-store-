...
3. Implement login + protected layout
4. สร้าง bottom navigation ใน SvelteKit app shell
5. Migrate dashboard page จาก UI เดิม
6. Migrate receive/stock/exchange pages ทีละหน้า
